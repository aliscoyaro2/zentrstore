...
export const Route = createFileRoute("/rider/apply/submitted")({
  head: () => ({
    meta: [{ title: "Application submitted — Zentra" }],
  }),
  component: RiderApplicationSubmitted,
});

function RiderApplicationSubmitted() {
  return (
    <Screen nav={false}>
      <div className="flex min-h-screen flex-col items-center justify-center px-6 py-10 text-center">
        ...
        <p className="mt-2 max-w-xs text-sm leading-relaxed text-muted-foreground">
          Thanks for applying to ride with Zentra. We'll review your details and get back to you soon.
        </p>
